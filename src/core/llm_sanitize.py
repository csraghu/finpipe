"""Normalize intel and social text before LLM prompts to reduce token waste."""
...
# Emoji and pictograph ranges (common social/news noise).
...
def sanitize_llm_text(text: str, *, preserve_newlines: bool = True) -> str:
    ...
    def _replace_url(match: re.Match[str]) -> str:
        return sanitize_llm_url(match.group(0).rstrip(".,);]"))
